...
begin
   ...
   begin
     ...
     begin
        ...
        begin
           ShowMessage('A Data de Fechamento não pode ser menor que a data '+DateToStr(Date));
...
procedure TForm_CancelamentoDeHospedagem.FormClose(Sender: TObject; var Action: TCloseAction);
begin
   Action:= caFree;
end;
