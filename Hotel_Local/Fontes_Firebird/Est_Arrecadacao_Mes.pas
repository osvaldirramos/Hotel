...
begin
   VS_Comando:= 'Select * from Historico where Ano = '+ComboBox_Ano.Text+' and DataPagamento is not null order by dataPagamento';
   IBQuery_Historico.Close;
...
procedure TForm_Est_Arrecadacao_Mes.SpeedButton_Atualiza_MapaClick(Sender: TObject);
begin
   Calcular;
end;

procedure TForm_Est_Arrecadacao_Mes.FormClose(Sender: TObject; var Action: TCloseAction);
begin
   Action:= caFree;
end;
