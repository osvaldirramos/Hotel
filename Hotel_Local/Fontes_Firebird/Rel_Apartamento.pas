...
//procedure TQRLabelsForm_Apto.QuickRepAfterPreview(Sender: TObject);
procedure TQRLabelsForm_Apto.QuickRepBeforePrint(Sender: TCustomQuickRep; var PrintReport: Boolean);
begin
   IBQuery_Apto.Open;
   IBTable_Cama.Open;
end;
