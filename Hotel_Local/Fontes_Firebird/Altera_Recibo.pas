...
begin
   ...
   VS_Recibo_Anterior:= DM.IBQuery_Executa.FieldByName('Nrecibo').AsString;
   Edit_NRecibo.Text:= FormatFloat('000000', StrToInt(Trim(DM.IBQuery_Executa.FieldByName('NRecibo').AsString)));
end;
