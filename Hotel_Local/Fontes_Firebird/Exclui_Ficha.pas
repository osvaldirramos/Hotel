...
begin
   ...
   begin
      ...
      VS_Comando:= 'Delete from hospedagem where ficha = '+#39+VS_Ficha+#39+' and Ano = '+Edit_Ano.Text;
      Funcoes.ExecSql_Servidor(VS_Comando);

      VS_Comando:= 'Delete from historico where ficha = '+#39+VS_Ficha+#39+' and Ano = '+Edit_Ano.Text;
      Funcoes.ExecSql_Servidor(VS_Comando);
...
procedure TForm_Exclui_Ficha.FormClose(Sender: TObject; var Action: TCloseAction);
begin
   Action:= caFree;
end;
