...
uses Module, Rel_Mapa_Ocupacao_R, Cad_Facilidades, Abertura, Cad_Hospede,
  Selecao_Data, Manual_OnLine, Rel_MapaOcupacao, CancelamentoDeHospedagem;
...
procedure TForm_MenuRecepcao.FormClose(Sender: TObject; var Action: TCloseAction);
begin
   Funcoes.Windows;
end;
