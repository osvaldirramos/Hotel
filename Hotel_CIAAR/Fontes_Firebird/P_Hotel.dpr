...
uses
  ...
  Est_Arrecadacao_Situacao in 'Est_Arrecadacao_Situacao.pas' {Form_Est_Arrecadacao_Situacao},
  Estatitica in 'Estatitica.pas' {Form_Estatistica},
...
begin
   ...
   begin
     Handle := FindWindow('Form_MostraTabPreco', nil);
     if Handle <> 0 then
     begin
  ...
  Application.CreateForm(TForm_CancelamentoDeHospedagem, Form_CancelamentoDeHospedagem);
  ProgressBar1.StepBy(1);
          ...
          Application.CreateForm(TForm_MostraTabPreco, Form_MostraTabPreco);
            ProgressBar1.StepBy(1);
            Update;
          Application.CreateForm(TForm_Tab_ResidenteBaseAreaManaus, Form_Tab_ResidenteBaseAreaManaus);
            ProgressBar1.StepBy(1);
            Update;
          ...
          Application.CreateForm(TForm_Est_Arrecadacao_Situacao, Form_Est_Arrecadacao_Situacao);
            ProgressBar1.StepBy(1);
            Update;

          Application.CreateForm(TForm_Estatistica, Form_Estatistica);
            ProgressBar1.StepBy(1);
            Update;
