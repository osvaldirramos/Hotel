...
begin
   ...
   if ((DM.Habilitado_Para = 'HOTEL CTA') or
       (DM.Habilitado_Para = 'CINDACTA III' )) then
   begin
...
begin
   ...
   begin      //--- Pagamento deve ser na tesouraria
      ...
      begin
         ...
         begin
            VI_Recibo:= StrToInt(Form_Cad_Hospede.MaskEdit_Ficha.Text);
         ...
         begin
            ...
            begin
               ...
               begin
                  if ((DM.Habilitado_Para = 'NATAL') or
                      (DM.Habilitado_Para = 'CINDACTA III')) then
                  begin
                     if Trim(UpperCase(IBTable_Hospede.FieldByName('SITUACAO_CURSO').AsString)) = 'RESIDENTE' then
                         Calcula_Hospede_Residente
