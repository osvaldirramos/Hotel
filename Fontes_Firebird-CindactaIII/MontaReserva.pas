...
type
  TForm_MontaReserva = class(TForm)
    ...
    GroupBox3: TGroupBox;
    MaskEdit_Quarto: TMaskEdit;
    GroupBox4: TGroupBox;
    MaskEdit_Cama: TMaskEdit;
    Bevel1: TBevel;
    GroupBox5: TGroupBox;
    MaskEdit_Sexo: TMaskEdit;
    IBTable_CadReservaSEXO: TIBStringField;
    ...
    procedure ComboBox_MesKeyPress(Sender: TObject; var Key: Char);
...
uses Module, Rel_Rela_Reserva, Cad_Reserva;
...
begin
//   IBQuery_Visao.Locate('Nome', VarArrayOf([MaskEdit_Busca_Nome_Completo.Text]), [loPartialKey]);
            ...
            case VI_Tipo of
               ...
               3: Begin    // DESOCUPADO
                     ...
                     begin
                        ...
                        MaskEdit_Quarto.Text:= IBQuery_Visao.FieldByName('Apto').AsString;
                        MaskEdit_Cama.Text:= IBQuery_Visao.FieldByName('Cama').AsString;
                     end;
                     ToolButton_Cancela_Reserva.Enabled:= False;
                  end;
...
begin
   ...
   begin
      ShowMessage('O Telefone não pode ser branco...');
      ...
      begin     //--- Tratamento para verificar se foi fornecido o numero da identidade
         ...
         begin
            ...
            begin
               ...
               begin
                  VS_Comando:= 'Select count(1) as Qtd from TABELA_POSTO where posto = '+#39+trim(ComboBox_Posto_Graduacao.Text)+#39;
               ...
               begin
                  ...
                  IBTable_CadReserva.FieldByName('Sexo').AsString:= MaskEdit_Sexo.Text;
                  ...
                  IBTable_CadReserva.FieldByName('APTO').AsString:= MaskEdit_Quarto.Text;
                  IBTable_CadReserva.FieldByName('CAMA').AsString:= MaskEdit_Cama.Text;
...
//                     VI_Cama:= IBQuery_Visao.FieldByName('Cama').AsInteger + 1;
                     VI_Cama:= StrToInt(MaskEdit_Cama.Text)+ 1;
                     VI_NDep:= 1;
...
procedure TForm_MontaReserva.ComboBox_MesKeyPress(Sender: TObject;
  var Key: Char);
begin
   if key = #13 then
      SpeedButton_AtualizarClick(Sender);
end;

procedure TForm_MontaReserva.ToolButton2Click(Sender: TObject);
begin
