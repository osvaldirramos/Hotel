...
type
  TForm_Cad_Apto = class(TForm)
    ...
    procedure Table_AptoPostError(DataSet: TDataSet; E: EDatabaseError; var Action: TDataAction);
...
procedure TForm_Cad_Apto.Table_AptoPostError(DataSet: TDataSet; E: EDatabaseError; var Action: TDataAction);
begin
...
begin
   ...
   begin
      ...
      begin
         ...
         ToolButton_Desocupar.Enabled:= False;
         ToolButton_Limpar.Enabled:= False;
      end
      else
      begin
   ...
   begin
      ...
      if ComboBox_Predio.Text = 'Todos' then
         VS_Comando:= 'select predio, apto, ramal, tv1, tv2, virtual, cama, aptcodigo, nome '+
                      'from Apto_View where cama > 0'
      else       // selecao por apto
         VS_Comando:= 'select predio, apto, ramal, tv1, tv2, virtual, cama, aptcodigo, nome '+
                      'from Apto_View '+
                      ' where cama > 0 and predio = '+#39+ComboBox_Predio.Text+#39;
