...
uses
  ...
  StdCtrls, DBCtrls, ComCtrls, Mask, Buttons, JvGradient, JvComponent, ComObj,
  JvxClock, jpeg, ToolWin, DBTables, Rotinas, JvToolEdit, JvLookOut,
  JvShape, JvCaptionPanel;
...
type
  TForm_MenuRecepcao = class(TForm)
    ...
    Label2: TLabel;
    ToolButton_BuscaVeiculos: TToolButton;
    ...
    Panel1: TPanel;
    Table_CanaArumada: TTable;
    DST_CamaArrumada: TDataSource;
    Table_CanaArumadaPREDIO: TStringField;
    Table_CanaArumadaAPTO: TFloatField;
    Table_CanaArumadaRAMAL: TStringField;
    Table_CanaArumadaTV1: TStringField;
    Table_CanaArumadaTV2: TStringField;
    Table_CanaArumadaVIRTUAL: TStringField;
    Table_CanaArumadaCAMA: TFloatField;
    Table_CanaArumadaAPTCODIGO: TStringField;
    Table_CanaArumadaNOME: TStringField;
    Panel5: TPanel;
    Panel2: TPanel;
    ...
    GroupBox_informacoesHospedagem: TGroupBox;
    Label1: TLabel;
    Label21: TLabel;
    Label22: TLabel;
    Label23: TLabel;
    ...
    JvShape1: TJvShape;
    JvShape2: TJvShape;
    JvExpressButton_CamaDisponivel: TJvExpressButton;
    DBNavigator1: TDBNavigator;
    DBGrid_CamaArrumada: TDBGrid;
    ...
    procedure ToolButton_BuscaVeiculosClick(Sender: TObject);
    ...
    procedure JvExpressButton_CamaDisponivelClick(Sender: TObject);
...
uses Module, Rel_Mapa_Ocupacao_R, Cad_Facilidades, Selecao_Data,
  Manual_OnLine, Abertura, Cad_Hospede, Rel_MapaOcupacao,
  RelacaoVeiculos, Previsao_Diaria;
...
procedure TForm_MenuRecepcao.ToolButton_BuscaVeiculosClick(Sender: TObject);
begin
   Form_RelacaoVeiculos.ShowModal;
end;

procedure TForm_MenuRecepcao.SpeedButton_PreviaClick(Sender: TObject);
begin
   Form_Previsao_Diaria.ShowModal;
end;

procedure TForm_MenuRecepcao.JvExpressButton_EstatisticaCursosAndamentoClick( Sender: TObject);
var
...
//------------------------------------------------------------------------------
//
procedure TForm_MenuRecepcao.RelacaoDeSaidas(Sender: TObject);
var
    VS_Comando: String;
begin
...
//------------------------------------------------------------------------------
// Passa a cama de arrumar para desocupada
//------------------------------------------------------------------------------

procedure TForm_MenuRecepcao.JvExpressButton_CamaDisponivelClick( Sender: TObject);
begin
   if Table_CanaArumada.FieldByName('Predio').AsString <> '' then
   begin
      Table_CanaArumada.Edit;
      Table_CanaArumada.FieldByName('Nome').AsString:= '';
      Table_CanaArumada.FieldByName('AptCodigo').AsString:= 'DESOCUPADO';
      Table_CanaArumada.Post;
   ...
   begin
       ShowMessage('Operação negada, não foi selecionado Prédio, Apto e Cama...')
   end;
end;


procedure TForm_MenuRecepcao.MaskEdit_Busca_NomeChange(Sender: TObject);
begin
...
procedure TForm_MenuRecepcao.Busca(VS_Busca: String);
Var
   VS_Comando: String;
begin
