...
type
  TForm_Sel_Predio = class(TForm)
    ...
    Table_Mapa_Hospede: TTable;
    Table_Mapa_HospedeIDENTIDADE: TStringField;
    Table_Mapa_HospedeNOME: TStringField;
    Table_Mapa_HospedeNOME_GUERRA: TStringField;
    Table_Mapa_HospedePOSTO: TStringField;
    Table_Mapa_HospedeSITUACAO_CURSO: TStringField;
    Table_Mapa_HospedeOM_ORIGEM: TStringField;
    Table_Mapa_Hospedagem: TTable;
    Table_Mapa_HospedagemIDENTIDADE: TStringField;
    Table_Mapa_HospedagemFICHA: TStringField;
    Table_Mapa_HospedagemPREDIO: TStringField;
    Table_Mapa_HospedagemAPTO: TFloatField;
    Table_Mapa_HospedagemCAMA: TFloatField;
    Table_Mapa_HospedagemSITUACAO_HOSPEDAGEM: TStringField;
    Table_Mapa_HospedagemDATAENTRADA: TStringField;
    Table_Mapa_HospedagemDATASAIDA: TStringField;
    DST_Mapa_Hospedagem: TDataSource;
    DST_Mapa_Historico: TDataSource;
    DST_Mapa_Hospede_Historico: TDataSource;
    Table_Mapa_Hospede_Historico: TTable;
    ...
    Table_Mapa_Historico: TTable;
    Table_Mapa_HistoricoIDENTIDADE: TStringField;
    Table_Mapa_HistoricoFICHA: TStringField;
    Table_Mapa_HistoricoPREDIO: TStringField;
    Table_Mapa_HistoricoAPTO: TFloatField;
    Table_Mapa_HistoricoDATAENTRADA: TStringField;
    Table_Mapa_HistoricoHORAENTRADA: TStringField;
    Table_Mapa_HistoricoDATASAIDA: TStringField;
    DSQ_Mapa: TDataSource;
    Query_NaoDesocupar: TQuery;
    Query_Monta_Mapa: TQuery;
    Query_Mapa_Cabecalho: TQuery;
    Query_Mapa_CabecalhoPREDIO: TStringField;
    Query_Mapa_CabecalhoAPTO: TFloatField;
    Query_Mapa_CabecalhoRAMAL: TStringField;
    Query_Mapa_CabecalhoTV1: TStringField;
    Query_Mapa_CabecalhoTV2: TStringField;
...
begin
   Table_Mapa_Historico.Open;
   Table_Mapa_Hospedagem.Open;
   Table_Mapa_Hospede_Historico.Open;
   Table_Mapa_Hospede.Open;
   Table_Reserva.Open;
...
var
   VS_Privilegio, VS_Comando: String;
   VI_Codigo: Integer;
begin
   //---
   // Monta o Mapa
   ...
   // Inicia a montagem do Mapa
    ...
    Executa_Query_Monta_Mapa(Query_Mapa_Cabecalho, VS_Comando);
    While not Query_Mapa_Cabecalho.Eof do
    begin
       ...
       Grava_Mapa(VI_Codigo,
                  Query_Mapa_Cabecalho.FieldByName('PREDIO').AsString,
                  Query_Mapa_Cabecalho.FieldByName('APTO').AsString,
                  '0',
                  Query_Mapa_Cabecalho.FieldByName('RAMAL').AsString,
                  ' ',
                  ' ',
                  CABECALHO,
                  Query_Mapa_Cabecalho.FieldByName('PREDIO').AsString+'    '+
                     Query_Mapa_Cabecalho.FieldByName('APTO').AsString+'    R. '+
                     Query_Mapa_Cabecalho.FieldByName('RAMAL').AsString+'    -    '+
                     Query_Mapa_Cabecalho.FieldByName('TV1').AsString+'  '+
                     Query_Mapa_Cabecalho.FieldByName('TV2').AsString,
                  ' ',
                  ' ',
                  ' ',
                  ' '
   ...
   //--- Monta a Reserva
    ...
    begin
       ...
       if Trim(Query_Monta_Mapa.fields[10].AsString ) = 'RESERVA' then
       begin
           VI_Codigo:= VI_Codigo + 1;
           Grava_Mapa(VI_Codigo,
                      ...
                      RESERVA,
                      Query_Monta_Mapa.FieldByName('cama').AsString+' - '+
                         trim(Query_Monta_Mapa.FieldByName('Posto').AsString)+' '+
                         Query_Monta_Mapa.FieldByName('nome_guerra').AsString,
                      Query_Monta_Mapa.FieldByName('situacao_curso').AsString,
                      Query_Monta_Mapa.FieldByName('nome').AsString,
                      Query_Monta_Mapa.FieldByName('dataentrada').AsString,
                      Query_Monta_Mapa.FieldByName('datasaida').AsString
                    );
       end;
       ...
       begin    //--- DEPENDENTE DE HOSPEDE
          ...
          begin
             ...
             Grava_Mapa(VI_Codigo,
                        ...
                        ' ',
                        OCUPADO,
                        Query_Monta_Mapa.FieldByName('cama').AsString+' - DEPENDENTE',
                        ' ',
                        ' ',
                        ' ',
                        ' '
          ...
          begin     //--- DESOCUPADO
             ...
             begin
                ...
                IBQuery_Verifica_Mapa.SQL.Add('Select distinct predio, apto, cama from Sel_Predio '+
                                            'where predio = '+#39+Query_Monta_Mapa.FieldByName('PREDIO').AsString+#39+' '+
                                            'and apto = '+#39+Query_Monta_Mapa.FieldByName('Apto').AsString+#39+' '+
                                            'and cama = '+#39+Query_Monta_Mapa.FieldByName('Cama').AsString+#39);
    ...
    Executa_Query_Monta_Mapa(Query_NaoDesocupar, VS_Comando);

    While not Query_NaoDesocupar.Eof do
    begin
       ProgressBar1.StepBy(1);
       Update;

       if Query_NaoDesocupar.FieldByName('nome').AsString = 'NÃO DESOCUPADO' then
       begin
          VI_Codigo:= VI_Codigo + 1;
          Grava_Mapa( VI_Codigo,
                      Query_NaoDesocupar.FieldByName('PREDIO').AsString,
                      Query_NaoDesocupar.FieldByName('apto').AsString,
                      Query_NaoDesocupar.FieldByName('cama').AsString,
                      Query_Monta_Mapa.FieldByName('Ramal').AsString,
                      ' ',
                      ' ',
                      NAODESOCUPADO,
                      Query_NaoDesocupar.FieldByName('cama').AsString+' - '+Trim(Table_Mapa_Hospede_Historico.FieldByName('Posto').AsString)+' - '+Trim(Table_Mapa_Hospede_Historico.FieldByName('Nome_Guerra').AsString),
                      Table_Mapa_Hospede_Historico.FieldByName('SITUACAO_CURSO').AsString,
                      Table_Mapa_Hospede_Historico.FieldByName('NOME').AsString,
                      Table_Mapa_Historico.FieldByName('DataEntrada').AsString,
                      Table_Mapa_Historico.FieldByName('DataSaida').AsString
                    );
       end
       else
       begin
          ...
          Grava_Mapa( VI_Codigo,
                      ...
                      ' ',
                      OCUPADO,
                      Query_NaoDesocupar.FieldByName('cama').AsString+' - '+Trim(Table_Mapa_Hospede.FieldByName('Posto').AsString)+' - '+Trim(Table_Mapa_Hospede.FieldByName('Nome_Guerra').AsString),
                      Table_Mapa_Hospede.FieldByName('SITUACAO_CURSO').AsString,
                      Table_Mapa_Hospede.FieldByName('NOME').AsString,
                      Table_Mapa_Hospedagem.FieldByName('DataEntrada').AsString,
                      Table_Mapa_Hospedagem.FieldByName('DataSaida').AsString
                    );
       end;

       Query_NaoDesocupar.Next;
    end;
...
procedure TForm_Sel_Predio.Executa_Query_Monta_Mapa(Query_Monta_Mapa: TQuery;VS_Comando: String);
begin
