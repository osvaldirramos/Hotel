#ifdef RCSID
static char *RCSid = 
   "$Header: cdemo3.c 7020100.1 94/09/23 22:19:31 cli Generic<base> $ ";
#endif /* RCSID */
...
/*
   ...
   MODIFIED   (MM/DD/YY)
    emendez    04/07/94 -  merge changes from branch 1.6.710.2
    gdoherty   04/06/94 -  merge changes from branch 1.6.710.1
    emendez    02/02/94 -  Fix for bug 157576
    gdoherty   02/02/94 -  make oci header inclusion for ansi or k+r adaptive
    tssmith    03/29/93 -  Removing ANSI C declarations 
